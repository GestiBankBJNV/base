...
public class ConseillerDaoTestUpdate {
	...
	public static void main(String[] args) {
		...
		// Conseiller avec le même id et le même matricule que c3, seul le nom est modifié
		Conseiller c4 = new Conseiller(3, "Janot", "Lapin", "Jojo", "1234",
				"jo@email.com", "0658656546", "conseiller", "427A", new Date(),
				new ArrayList<Client>(), new ArrayList<DemandeInscription>());
		dao.updateConseiller(c4);
